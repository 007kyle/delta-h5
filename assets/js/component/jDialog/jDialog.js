;(function (window, document) {
    ...
    function _createModal(context) {
        ...
        element.style.cssText =
            ';background:rgba(0,0,0,0.3);height:100%;width:100%;position:absolute;left:0;top:0;right:0;bottom:0;z-index:' + (self.currentDOMIndex - 1);
    ...
    jDialog.fn.extend({
        ...
        getWrapper: function () {
            if (!this.wrapper) {
                ...
                this.wrapper = _createElement('div', {
                    className: prefix + 'du-dialog'
                });

                this.wrapper.style.zIndex = this.currentDOMIndex = 9999;
            }
        ...
        hideHeader: function () {
            ...
            this.getWrapper().removeChild(header);
            return this;
        },
        ...
        addButton: function (text, actionName, handler) {
            ...
            var element = _createElement('a', {
                ...
                className: prefix + 'du-dialog-btn',
            ...
            if (this.buttons.length) {
                this.addClass("du-dialog-btn-primary", element);
                footer.insertBefore(element, footer.childNodes.item(0));
            } else {
                this.addClass("du-dialog-btn-default", element);
        ...
        remove: function () {
            ...
            // this.actions = [];
            jDialog.currentDialog = this.buttons = this.container = this.footer = this.header = this.options = this.wrapper = this.modal = null;
    ...
    jDialog.extend({
        ...
        loading: function (typeClass) {
            var typeClass = typeClass || 'a'
            var html = '<div class="thumb-outer thumb-outer-' + typeClass +'"><div class="thumb-inner"></div></div>';
            var dialog = jDialog(html)
                            .hideFooter()
                            .hideHeader()
                            .addClass('du-dialog-loading')
                            .preventHide()
                            .height('auto');
        ...
        error: function (message, callBack) {
            return jDialog(message, callBack).addClass('du-dialog-error');
        }
    });
